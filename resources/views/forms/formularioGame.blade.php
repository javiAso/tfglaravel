    ...
    <div class="row">
        <div class="col-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="gameName" name="gameName" placeholder="Game tittle">
          </div>
          <div class="form-group">
        ...
        <div class="col-6">
          <div class="form-group">
            ...
            <textarea id="gameDescription" name="gameDescription" cols="30" rows="5" placeholder="Write an introduction for your new game"></textarea>
          </div>
        </div>
      </div>
      <div class="row pl-4">
