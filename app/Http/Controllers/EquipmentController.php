...

{
    ...
    public function addItem(Request $request){
        ...
        session('cesta')->addProduct($request->itemID);
        var_dump(session('cesta')->getListadoProductos());
    ...
    public function showStore(){
        ...
        return view('equipment', ['items' => $items , 'armors' => $armors , 'weaponsM' => $weaponsM , 'weaponsR' => $weaponsR]);
